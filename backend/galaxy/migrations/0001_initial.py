# Generated by Django 3.0.6 on 2020-09-03 20:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plateifu', models.CharField(blank=True, help_text='Plate+ifudesign name for this object (e.g. 7443-12701)', max_length=100, null=True, verbose_name='Plate IFU Design ID')),
                ('mangaid', models.CharField(blank=True, help_text='MaNGA ID for this object (e.g. 1-114145)', max_length=100, null=True, verbose_name='MaNGA ID')),
