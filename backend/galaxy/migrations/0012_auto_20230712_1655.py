    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Indicates whether the object has an extra bz2 file containing the comp_larga attribute. when true, it affects the download function, which makes 2 files available.",
                verbose_name="bcomp",
            ),
        ),
    ]
