...
def ifscube_slicer(cube):
    ...
    for p in pars:
         ...
         if p[1] == 'A':
            ...
            k=k+1
            plt.imshow(save_flux,origin='lower')  # plot para tu poder conferir (note o origim do matplotlib que precisa ser lower para o 0,0 ser no canto inferior esquerdo)
